                    ...
                    <div className="row">
                        <div className="col-md-6 mb-4">
                            <div className="form-group">
                                ...
                                <input type="txt" className="form-control rounded" id="Client_name" aria-describedby="Imput name" placeholder="Ingrese un nombre" required
                                    onChange={
                        ...
                        <div className="col-md-6 mb-4">
                            <div className="form-group">
                                ...
                                <input type="txt" className="form-control rounded" id="IPAddress" placeholder="0.0.0.0" required
                                    onChange={
                        ...
                        <div className="col-md-6 mb-4">
                            <div className="form-group">
                                ...
                                <input type="txt" className="form-control rounded" id="PublicToken" placeholder="Ingrese el token público" required
                                    onChange={
                        ...
                        <div className="col-md-6 mb-4">
                            <div className="form-group">
                                ...
                                <input type="txt" className="form-control rounded" id="PrivateToken" placeholder="Ingrese el token privado" required
                                    onChange={
                        ...
                        <div className="col-md-6 mb-4">
                            <div className="form-group">
                                ...
                                <input type="txt" className="form-control rounded" id="UserName" placeholder="Nombre de usuario"
                                    onChange={
                        ...
                        <div className="col-md-6 mb-4">
                            <div className="form-group">
                                ...
                                <input type="password" className="form-control rounded" id="password" placeholder="Contraseña" required
                                    onChange={
